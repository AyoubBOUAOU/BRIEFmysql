...
CREATE DATABASE /*!32312 IF NOT EXISTS*/ `MYSQLIX` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
CREATE TABLE `habitant` (
  ...
  CONSTRAINT `habitant_ibfk_2` FOREIGN KEY (`num_qualite`) REFERENCES `qualité` (`num_qualite`)
...
LOCK TABLES `qualité` WRITE;
/*!40000 ALTER TABLE `qualité` DISABLE KEYS */;
INSERT INTO `qualité` VALUES (1,'Chef'),(2,'Druide'),(3,'Barde'),(4,'Guerrier'),(5,'Chasseur'),(6,'Livreur de menhirs'),(7,'Facteur'),(8,'Poissonnière'),(9,'Serveuse');
/*!40000 ALTER TABLE `qualité` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2021-02-23 12:44:38
